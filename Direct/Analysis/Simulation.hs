...
-- | Module Direct.Analysis.Simulation
--
-- Simulate races using the performance model. This module uses gamma
-- parameters directly as ratings.
module Direct.Analysis.Simulation
    ( SimPip(..)
    , SimEntry(..)
    , toSimPips
...
toSimPips probes rtgs = map (second orbitalDistr)
...
runExperimentProbe simOpts pips =
    ...
    probeModel = orbitalDistr (simProbeRating simOpts)
    probeId = Probe 0
