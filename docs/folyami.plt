set autoscale
set style line 100 lc 'gray' lw 1
set style line 101 dashtype 3 lc 'gray' lw 1
set grid xtics mxtics ls 100, ls 101
set grid ytics mytics ls 100, ls 101

# https://github.com/Gnuplotting/gnuplot-palettes/blob/master/paired.pal
